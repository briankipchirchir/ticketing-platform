...
public class TicketController {
    ...
    public ResponseEntity<List<TicketResponse>> bookTickets(
        ...
        // authHeader is the raw "Bearer <token>" string from this request,
        // forwarded as-is so event-service can authenticate the reserve call
        return ResponseEntity.ok(ticketService.bookTickets(request, userEmail, authHeader));
    }
